...
const AVR_opcode_data avr_opcodes[164] = {
  ...
  {0xf000, 0x5000, 1, "0101 KKKK  dddd KKKK", OP_AVR1,    OPCODE_subi, "subi", "Rd, K", "Subtract Immediate", "Rd <-- Rd-K", "Z,C,N,V,S,H", {"1", "1", "1", "1"}, "d = 16..31"},
  ...
  {0xf000, 0x6000, 1, "0110 KKKK  dddd KKKK", OP_AVR1,    OPCODE_ori, "ori", "Rd, K", "Logical OR with Immediate", "Rd <-- Rd|K", "Z,N,V,S", {"1", "1", "1", "1"}, "d = 16..31"},
  {0xfc00, 0x2400, 1, "0010 01rd  dddd rrrr", OP_AVR1,    OPCODE_eor, "eor", "Rd, Rr", "Exclusive OR", "Rd <-- Rd^Rr", "Z,N,V,S", {"1", "1", "1", "1"}, ""},
  {0xfe0f, 0x9400, 1, "1001 010d  dddd 0000", OP_AVR1,    OPCODE_com, "com", "Rd", "One's Complement", "Rd <-- 0xff - Rd", "Z,C,N,V,S", {"1", "1", "1", "1"}, ""},
  {0xfe0f, 0x9401, 1, "1001 010d  dddd 0001", OP_AVR1,    OPCODE_neg, "neg", "Rd", "Two's Complement", "Rd <-- 0x00 - Rd", "Z,C,N,V,S,H", {"1", "1", "1", "1"}, ""},
  {0xf000, 0x6000, 1, "0110 KKKK  dddd KKKK", OP_AVR1,    OPCODE_sbr, "sbr", "Rd, K", "Set Bit(s) in Register", "Rd <-- Rd or K", "Z,N,V,S", {"1", "1", "1", "1"}, "alias for ori Rd, K; d = 16..31"},
  {0xf000, 0x7000, 1, "0111 KKKK  dddd KKKK", OP_AVR1,    OPCODE_cbr, "cbr", "Rd, K", "Clear Bit(s) in Register", "Rd <-- Rd & (0xff - K)", "Z,N,V,S", {"1", "1", "1", "1"}, "alias for andi Rd, (0xff - K); d = 16..31"},
  ...
  {0xfc00, 0x2000, 1, "0010 00r=  rrrr ====", OP_AVR1,    OPCODE_tst, "tst", "Rr", "Test for Zero or Minus", "Rr <-- Rr & Rr", "Z,N,V,S", {"1", "1", "1", "1"}, "alias for and Rd, Rd"},
  {0xfc00, 0x2400, 1, "0010 01d=  dddd ====", OP_AVR1,    OPCODE_clr, "clr", "Rd", "Clear Register", "Rd <-- Rd xor Rd", "Z,N,V,S", {"1", "1", "1", "1"}, "alias for eor Rd, Rd"},
  {0xff0f, 0xef0f, 1, "1110 1111  dddd 1111", OP_AVR1,    OPCODE_ser, "ser", "Rd", "Set Register", "Rd <-- 0xff", "None", {"1", "1", "1", "1"}, "alias for ldi Rd, 0xff; d = 16..31"},
  ...
  {0xff88, 0x0308, 1, "0000 0011  0ddd 1rrr", OP_AVR4,    OPCODE_fmul, "fmul", "Rd, Rr", "Fractional Multiply Unsigned", "R1:R0 <-- Rd x Rr<<1 (UU)", "Z,C", {"2", "2", "2", "n/a"}, "d, r = 16..23"},
  {0xff88, 0x0380, 1, "0000 0011  1ddd 0rrr", OP_AVR4,    OPCODE_fmuls, "fmuls", "Rd, Rr", "Fractional Multiply Signed", "R1:R0 <-- Rd x Rr<<1 (SS)", "Z,C", {"2", "2", "2", "n/a"}, "d, r = 16..23"},
  {0xff88, 0x0388, 1, "0000 0011  1ddd 1rrr", OP_AVR4,    OPCODE_fmulsu, "fmulsu", "Rd, Rr", "Fractional Multiply Signed with Unsigned", "R1:R0 <-- Rd x Rr<<1 (SU)", "Z,C", {"2", "2", "2", "n/a"}, "d, r = 16..23"},
  ...
  {0xffff, 0x9419, 1, "1001 0100  0001 1001", OP_AVR_XL,  OPCODE_eijmp, "eijmp", "-", "Extended Indirect Jump to (Z)", "PC(15:0) <-- Z, PC(21:16) <-- EIND", "None", {"2", "2", "2", "n/a"}, ""},
  ...
  {0xffff, 0x9519, 1, "1001 0101  0001 1001", OP_AVR_XL,  OPCODE_eicall, "eicall", "-", "Extended Indirect Call to (Z)", "PC(15:0) <-- Z, PC(21:16) <-- EIND", "None", {"4", "3", "3", "n/a"}, ""},
  ...
  {0xff00, 0x0100, 1, "0000 0001  dddd rrrr", OP_AVR25,   OPCODE_movw, "movw", "Rd, Rr", "Copy Register Pair", "Rd+1:Rd <-- Rr+1:Rr", "None", {"1", "1", "1", "n/a"}, "d, r in {0, 2, ..., 30}"},
  ...
  {0xf800, 0xa000, 1, "1010 0aaa  dddd aaaa", OP_AVR_RC,  OPCODE_lds_rc, "lds", "Rd, a", "Load Direct from data space", "Rd <-- (a)", "None", {"n/a", "n/a", "n/a", "2"}, "AVRrc only (TPI parts); a = 0x40..0xbf"},
  ...
  {0xfe0f, 0x9200, 2, "1001 001r  rrrr 0000    kkkk kkkk  kkkk kkkk", OP_AVR2nRC, OPCODE_sts, "sts", "k, Rr", "Store Direct to Data Space", "(k) <-- Rr", "None", {"2", "2", "2", "1"}, ""},
  {0xf800, 0xa800, 1, "1010 1aaa  rrrr aaaa", OP_AVR_RC,  OPCODE_sts_rc, "sts", "a, Rr", "Store Direct to Data Space", "(a) <-- Rr", "None", {"n/a", "n/a", "n/a", "1"}, "AVRrc only (TPI parts); a = 0x40..0xbf"},
  ...
  {0xfe0f, 0x920f, 1, "1001 001r  rrrr 1111", OP_AVR2,    OPCODE_push, "push", "Rr", "Push Register on Stack", "STACK <-- Rr", "None", {"2", "1", "1", "1"}, ""},
  ...
  {0xfe0f, 0x9206, 1, "1001 001d  dddd 0110", OP_AVR_XM,  OPCODE_lac, "lac", "Z, Rd", "Load and Clear", "(Z) <-- (0xff - Rd) & (Z), Rd <-- (Z)", "None", {"n/a", "1", "n/a", "n/a"}, ""},
  {0xfe0f, 0x9207, 1, "1001 001d  dddd 0111", OP_AVR_XM,  OPCODE_lat, "lat", "Z, Rd", "Load and Toggle", "(Z) <-- Rd^(Z), Rd <-- (Z)", "None", {"n/a", "1", "n/a", "n/a"}, ""},

  // Bit and Bit-test Instructions
  {0xfc00, 0x0c00, 1, "0000 11d=  dddd ====", OP_AVR1,    OPCODE_lsl, "lsl", "Rd", "Logical Shift Left", "C <-- Rd(7) <-- Rd(6) ... Rd(1) <-- Rd(0) <-- 0", "Z,C,N,V,H", {"1", "1", "1", "1"}, "alias for add Rd, Rd"},
  ...
  {0xfc00, 0x1c00, 1, "0001 11d=  dddd ====", OP_AVR1,    OPCODE_rol, "rol", "Rd", "Rotate Left Through Carry", "C <-- Rd(7) <-- Rd(6) ... Rd(1) <-- Rd(0) <-- C", "Z,C,N,V,H", {"1", "1", "1", "1"}, "alias for adc Rd, Rd"},
  ...
  {0xfe08, 0xfa00, 1, "1111 101r  rrrr 0bbb", OP_AVR1,    OPCODE_bst, "bst", "Rr, b", "Bit Store from Register to T", "T <-- Rr(b)", "T", {"1", "1", "1", "1"}, ""},
  ...
  // Unallocated codes
  {0xff00, 0x0000, 1, "0000 0000  xxxx xxxx", OP_AVR_ILL, OPCODE_x_nop_1, "u/nop", "-", "alt No Operation", "-", "None", {"1", "1", "1", "1"}, "xxxx xxxx != 0000 0000"},
  {0xfe0f, 0x9003, 1, "1001 000x  xxxx 0011", OP_AVR_ILL, OPCODE_x_nop_2, "u/nop", "-", "alt No Operation", "-", "None", {"1", "1", "1", "1"}, ""},
  {0xfe0f, 0x9008, 1, "1001 000x  xxxx 1000", OP_AVR_ILL, OPCODE_x_nop_3, "u/nop", "-", "alt No Operation", "-", "None", {"1", "1", "1", "1"}, ""},
  {0xfe0f, 0x900b, 1, "1001 000x  xxxx 1011", OP_AVR_ILL, OPCODE_x_nop_4, "u/nop", "-", "alt No Operation", "-", "None", {"1", "1", "1", "1"}, ""},
  {0xfe0f, 0x9203, 1, "1001 001x  xxxx 0011", OP_AVR_ILL, OPCODE_x_nop_5, "u/nop", "-", "alt No Operation", "-", "None", {"1", "1", "1", "1"}, ""},
  {0xfe0f, 0x9208, 1, "1001 001x  xxxx 1000", OP_AVR_ILL, OPCODE_x_nop_6, "u/nop", "-", "alt No Operation", "-", "None", {"1", "1", "1", "1"}, ""},
  {0xfe0f, 0x920b, 1, "1001 001x  xxxx 1011", OP_AVR_ILL, OPCODE_x_nop_7, "u/nop", "-", "alt No Operation", "-", "None", {"1", "1", "1", "1"}, ""},
  {0xff1f, 0x9509, 1, "1001 0101  xxx0 1001", OP_AVR_ILL, OPCODE_x_icall,  "u/icall", "Z", "alt Indirect Call to (Z)", "PC(15:0) <-- Z, PC(21:16) <-- 0", "None", {"3/4", "2/3", "2/3", "3"}, "xxx != 000"},
  {0xff1f, 0x9519, 1, "1001 0101  xxx1 1001", OP_AVR_ILL, OPCODE_x_eicall,  "u/eicall", "-", "alt Extended Indirect Call to (Z)", "PC(15:0) <-- Z, PC(21:16) <-- EIND", "None", {"4", "3", "3", "n/a"}, "xxx != 000"},
  {0xff9f, 0x9508, 1, "1001 0101  0xx0 1000", OP_AVR_ILL, OPCODE_x_ret, "u/ret", "-", "alt Subroutine Return", "PC <-- STACK", "None", {"4/5", "4/5", "4/5", "6"}, "xx != 00"},
  {0xff9f, 0x9518, 1, "1001 0101  0xx1 1000", OP_AVR_ILL, OPCODE_x_reti,  "u/reti", "-", "alt Interrupt Return", "PC <-- STACK", "I", {"4/5", "4/5", "4/5", "6"}, "xx != 00"},
  {0xffff, 0x95b8, 1, "1001 0101  1011 1000", OP_AVR_ILL, OPCODE_x_nop_8, "u/nop", "-", "alt No Operation", "-", "None", {"1", "1", "1", "1"}, ""},
  {0xfe0f, 0x9404, 1, "1001 010x  xxxx 0100", OP_AVR_ILL, OPCODE_x_nop_9, "u/nop", "-", "alt No Operation", "-", "None", {"1", "1", "1", "1"}, ""},
  {0xff0f, 0x950b, 1, "1001 0101  xxxx 1011", OP_AVR_ILL, OPCODE_x_nop_a, "u/nop", "-", "alt No Operation", "-", "None", {"1", "1", "1", "1"}, ""},
  {0xff1f, 0x9409, 1, "1001 0100  xxx0 1001", OP_AVR_ILL, OPCODE_x_ijmp, "u/ijmp", "Z", "alt Indirect Jump to (Z)", "PC(15:0) <-- Z, PC(21:16) <-- 0", "None", {"2", "2", "2", "2"}, "xxx != 000"},
  {0xff1f, 0x9419, 1, "1001 0100  xxx1 1001", OP_AVR_ILL, OPCODE_x_eijmp,  "u/eijmp", "-", "alt Extended Indirect Jump to (Z)", "PC(15:0) <-- Z, PC(21:16) <-- EIND", "None", {"2", "2", "2", "n/a"}, "xxx != 000"},
  {0xfe08, 0xf808, 1, "1111 100d  dddd 1bbb", OP_AVR_ILL, OPCODE_x_bld, "u/bld", "Rd, b", "alt Bit load from T to Register", "Rd(b) <-- T", "None", {"1", "1", "1", "1"}, ""},
  {0xfe08, 0xfa08, 1, "1111 101r  rrrr 1bbb", OP_AVR_ILL, OPCODE_x_bst, "u/bst", "Rr, b", "alt Bit Store from Register to T", "T <-- Rr(b)", "T", {"1", "1", "1", "1"}, ""},
  {0xfe08, 0xfc08, 1, "1111 110r  rrrr 1bbb", OP_AVR_ILL, OPCODE_x_sbrc, "u/sbrc", "Rr, b", "alt Skip if Bit in Register Cleared", "if(Rr(b)=0)PC <-- PC+2or3", "None", {"1-3", "1-3", "1-3", "1/2"}, ""},
  {0xfe08, 0xfe08, 1, "1111 111r  rrrr 1bbb", OP_AVR_ILL, OPCODE_x_sbrs, "u/sbrs", "Rr, b", "alt Skip if Bit in Register Set", "if(Rr(b)=1)PC <-- PC+2or3", "None", {"1-3", "1-3", "1-3", "1/2"}, ""},
};
