...
const AVR_opcode_data avr_opcodes[164] = {
  ...
  {0xfc00, 0x2000, 1, "0010 00d=  dddd ====", OP_AVR1,    OPCODE_tst, "tst", "Rd", "Test for Zero or Minus", "Rd <-- Rd & Rd", "Z,N,V,S", {"1", "1", "1", "1"}, "alias for AND Rd, Rd"},
  ...
  {0xfe08, 0xfa08, 1, "1111 101d  dddd 1bbb", OP_AVR_ILL, OPCODE_x_bst, "u/bst", "Rd, b", "alt Bit Store from Register to T", "T <-- Rd(b)", "T", {"1", "1", "1", "1"}, ""},
