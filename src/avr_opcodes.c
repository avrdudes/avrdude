...
const AVR_opcode_data avr_opcodes[164] = {
  ...
  {0xf000, 0x7000, 1, "0111 KKKK  dddd KKKK", OP_AVR1,    OPCODE_cbr, "cbr", "Rd, K", "Clear Bit(s) in Register", "Rd <-- Rd & ($FFh-K)", "Z,N,V,S", {"1", "1", "1", "1"}, "alias for andi Rd, (0xFF - K); d = 16..31"},
  ...
  {0xf800, 0xa800, 1, "1010 1kkk  rrrr kkkk", OP_AVR_RC,  OPCODE_sts_rc, "sts", "k, Rr", "Store Direct to Data Space", "(k) <-- Rr", "None", {"n/a", "n/a", "n/a", "1"}, "AVRrc only (TPI parts)"},
