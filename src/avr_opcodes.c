...
const AVR_opcode_data avr_opcodes[164] = {
  ...
  {0xfc00, 0x1000, 1, "0001 00rd dddd rrrr", OP_AVR1,    OPCODE_cpse, "cpse", "Rd, Rr", "Compare, Skip if Equal", "if(Rd=Rr)PC <-- PC+2or3", "None", "1/2/3", "1/2/3", "1/2/3", "1/2", ""},
  ...
  {0xfe08, 0xfc00, 1, "1111 110r rrrr 0bbb", OP_AVR1,    OPCODE_sbrc, "sbrc", "Rr, b", "Skip if Bit in Register Cleared", "if(Rr(b)=0)PC <-- PC+2or3", "None", "1/2/3", "1/2/3", "1/2/3", "1/2", ""},
  {0xfe08, 0xfe00, 1, "1111 111r rrrr 0bbb", OP_AVR1,    OPCODE_sbrs, "sbrs", "Rr, b", "Skip if Bit in Register Set", "if(Rr(b)=1)PC <-- PC+2or3", "None", "1/2/3", "1/2/3", "1/2/3", "1/2", ""},
  {0xff00, 0x9900, 1, "1001 1001 AAAA Abbb", OP_AVR1,    OPCODE_sbic, "sbic", "A, b", "Skip if Bit in I/O Register Cleared", "if(I/O(A,b)=0)PC <-- PC+2or3", "None", "1/2/3", "2/3/4", "1/2/3", "1/2", ""},
  {0xff00, 0x9b00, 1, "1001 1011 AAAA Abbb", OP_AVR1,    OPCODE_sbis, "sbis", "A, b", "Skip if Bit in I/O Register Set", "If(I/O(A,b)=1)PC <-- PC+2or3", "None", "1/2/3", "2/3/4", "1/2/3", "1/2", ""},
