...
#define UPDI_V4_NVMCTRL_CTRLA                  0x00
#define UPDI_V4_NVMCTRL_CTRLB                  0x01
#define UPDI_V4_NVMCTRL_CTRLC                  0x02
#define UPDI_V4_NVMCTRL_INTCTRL                0x04
#define UPDI_V4_NVMCTRL_INTFLAGS               0x05
#define UPDI_V4_NVMCTRL_STATUS                 0x06
#define UPDI_V4_NVMCTRL_DATAL                  0x08
#define UPDI_V4_NVMCTRL_DATAH                  0x09
#define UPDI_V4_NVMCTRL_ADDR0                  0x0c
#define UPDI_V4_NVMCTRL_ADDR1                  0x0d
#define UPDI_V4_NVMCTRL_ADDR2                  0x0e
#define UPDI_V4_NVMCTRL_ADDR3                  0x0f

// NVMCTRL v2 CTRLA
#define UPDI_V4_NVMCTRL_CTRLA_NOCMD              0x00
#define UPDI_V4_NVMCTRL_CTRLA_NOOP               0x01
#define UPDI_V4_NVMCTRL_CTRLA_FLASH_WRITE        0x02
#define UPDI_V4_NVMCTRL_CTRLA_FLASH_PAGE_ERASE   0x08
#define UPDI_V4_NVMCTRL_CTRLA_EEPROM_WRITE       0x12
#define UPDI_V4_NVMCTRL_CTRLA_EEPROM_ERASE_WRITE 0x13
#define UPDI_V4_NVMCTRL_CTRLA_EEPROM_BYTE_ERASE  0x18
#define UPDI_V4_NVMCTRL_CTRLA_CHIP_ERASE         0x20
#define UPDI_V4_NVMCTRL_CTRLA_EEPROM_ERASE       0x30

// NVMCTRL STATUS
#define UPDI_V4_NVM_STATUS_WRITE_ERROR_MASK 0x70
#define UPDI_V4_NVM_STATUS_WRITE_ERROR_BIT     4
#define UPDI_V4_NVM_STATUS_EEPROM_BUSY_BIT     0
#define UPDI_V4_NVM_STATUS_FLASH_BUSY_BIT      1
...
int updi_nvm_chip_erase_V4(const PROGRAMMER *pgm, const AVRPART *p) {
/*
    def chip_erase(self):
        """
...
int updi_nvm_erase_flash_page_V4(const PROGRAMMER *pgm, const AVRPART *p, uint32_t address) {
/*
...
int updi_nvm_erase_eeprom_V4(const PROGRAMMER *pgm, const AVRPART *p) {
/*
...
int updi_nvm_command_V4(const PROGRAMMER *pgm, const AVRPART *p, uint8_t command) {
/*
...
*/
  ...
  return updi_write_byte(pgm, p->nvm_base + UPDI_V4_NVMCTRL_CTRLA, command);
}
